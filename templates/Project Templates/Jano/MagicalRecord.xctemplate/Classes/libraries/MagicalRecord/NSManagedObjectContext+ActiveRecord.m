...
{
	debug(@"Merging changes to %@context%@", 
...
- (BOOL) save
{
	...
	{
		debug(@"Problem saving: %@", (id)[exception userInfo] ?: (id)[exception reason]);
	}
...
+ (NSManagedObjectContext *) contextWithStoreCoordinator:(NSPersistentStoreCoordinator *)coordinator
{
    ...
    if (coordinator != nil)
	{
        debug(@"Creating MOContext %@", [NSThread isMainThread] ? @" *** On Main Thread ***" : @"");
